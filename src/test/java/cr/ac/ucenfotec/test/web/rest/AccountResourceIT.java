...
import cr.ac.ucenfotec.test.config.Constants;
import cr.ac.ucenfotec.test.domain.User;
import cr.ac.ucenfotec.test.repository.AuthorityRepository;
import cr.ac.ucenfotec.test.repository.UserRepository;
import cr.ac.ucenfotec.test.security.AuthoritiesConstants;
import cr.ac.ucenfotec.test.service.UserService;
import cr.ac.ucenfotec.test.service.dto.PasswordChangeDTO;
import cr.ac.ucenfotec.test.service.dto.UserDTO;
import cr.ac.ucenfotec.test.web.rest.vm.KeyAndPasswordVM;
import cr.ac.ucenfotec.test.web.rest.vm.ManagedUserVM;
...
import static cr.ac.ucenfotec.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
