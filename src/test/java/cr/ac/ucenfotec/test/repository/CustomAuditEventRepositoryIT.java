...
import cr.ac.ucenfotec.test.config.audit.AuditEventConverter;
import cr.ac.ucenfotec.test.domain.PersistentAuditEvent;
...
import static cr.ac.ucenfotec.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
